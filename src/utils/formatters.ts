...
export const BUSINESS_TYPES_CATALOG: BusinessTypeOption[] = [
  ...
  {
    id: 'pharmacy',
    name: 'Duka la Dawa & Famasi (Pharmacy)',
    emoji: '💊',
    description: 'Usimamizi wa dawa, tarehe za kuisha (expiry), namba za baachi, dozi za wagonjwa na TMDA',
...
> = {
  ...
  pharmacy: { label: 'EBS Duka la Dawa & Famasi (Pharmacy)', description: 'Usimamizi wa dawa, tarehe za kuisha (expiry), namba za baachi, dozi za wagonjwa na TMDA', emoji: '💊' },
...
> = {
  ...
  boss: {
    label: 'Bosi / Mmiliki Mkuu (Boss)',
    badgeColor: 'bg-amber-100 text-amber-900 dark:bg-amber-950 dark:text-amber-300',
    description: 'Mmiliki mkuu wa biashara na msimamizi wa akaunti zote'
  },
  super_admin: {
    label: 'EBS Head Office (Super Admin)',
    badgeColor: 'bg-rose-100 text-rose-900 dark:bg-rose-950 dark:text-rose-300',
    description: 'Msimamizi wa ngazi ya juu wa mfumo mzima wa EBS'
  },
};
